...
Note: teammates will each need to run `~/.claude/skills/gstack/setup` (cloned via `git clone --single-branch --depth 1 https://github.com/garrytan/gstack.git ~/.claude/skills/gstack`) locally to install the skill suite; this file only documents usage conventions.
